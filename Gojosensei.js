...
module.exports = GojoMdNx = async (GojoMdNx, m, chatUpdate, store) => {
  try {
    ...
    const groupMetadata = m.isGroup
      ? await GojoMdNx.groupMetadata(m.chat).catch((e) => {})
      : "";
    ...
    if (db.data.settings[botNumber].autobio) {
      ...
      if (new Date() * 1 - setting.status > 1000) {
        ...
        await GojoMdNx.setStatus(
          `${GojoMdNx.user.name} | Runtime : ${runtime(uptime)}`
        );
    ...
    if (db.data.chats[m.chat].antilink) {
      if (budy.match(`chat.whatsapp.com`)) {
        ...
        let gclink =
          ...
          (await GojoMdNx.groupInviteCode(m.chat));
...
${Array.from(room.jawaban, (jawaban, index) => {
  ...
  .join("\n")}
    ${isSurender ? "" : `Perfect Player`}`.trim();
      GojoMdNx.sendText(m.chat, caption, m, {
...
Typed *surrender* to surrender and admited defeat`;
      ...
      if (room.x !== room.o)
        await GojoMdNx.sendText(room.x, str, m, {
...
Type *surrender* to surrender and admit defeat`;
            ...
            await GojoMdNx.sendText(room.o, str, m, {
              mentions: parseMention(str),
            });
          } else {
            room = {
...
Please @${m.mentionedJid[0].split`@`[0]} To Type Accept/Reject`;
          this.suit[id] = {
            chat: await GojoMdNx.sendText(m.chat, caption, m, {
            ...
            waktu: setTimeout(() => {
              if (this.suit[id])
                GojoMdNx.sendText(m.chat, `_Suit Time Out_`, m);
              delete this.suit[id];
            }, 60000),
            poin,
            poin_lose,
      ...
      case "chat":
        {
          ...
          if (args[0] === "mute") {
            GojoMdNx.chatModify({ mute: "Infinity" }, m.chat, [])
              .then((res) => reply(jsonformat(res)))
              .catch((err) => reply(jsonformat(err)));
          } else if (args[0] === "unmute") {
            GojoMdNx.chatModify({ mute: null }, m.chat, [])
              .then((res) => reply(jsonformat(res)))
              .catch((err) => reply(jsonformat(err)));
          } else if (args[0] === "archive") {
            GojoMdNx.chatModify({ archive: true }, m.chat, [])
              .then((res) => reply(jsonformat(res)))
              .catch((err) => reply(jsonformat(err)));
          } else if (args[0] === "unarchive") {
            GojoMdNx.chatModify({ archive: false }, m.chat, [])
              .then((res) => reply(jsonformat(res)))
              .catch((err) => reply(jsonformat(err)));
          } else if (args[0] === "read") {
            GojoMdNx.chatModify({ markRead: true }, m.chat, [])
              .then((res) => reply(jsonformat(res)))
              .catch((err) => reply(jsonformat(err)));
          } else if (args[0] === "unread") {
            GojoMdNx.chatModify({ markRead: false }, m.chat, [])
              .then((res) => reply(jsonformat(res)))
              .catch((err) => reply(jsonformat(err)));
      ...
      case "guess":
        {
          ...
          if (args[0] === "song") {
            ...
            let msg = await GojoMdNx.sendMessage(
              m.chat,
...
Cieeee, What's Going On❤️💖👀`;
      ...
      case "checkdeath":
        if (!text)
          return replay(
            `Use Someone's Name, Example : ${prefix + command} nexus`
          );
      ...
      case "join":
        {
          ...
          await GojoMdNx.groupAcceptInvite(result)
            .then((res) => reply(jsonformat(res)))
            .catch((err) => reply(jsonformat(err)));
        }
        break;
      case "leave":
        {
          if (!isCreator) return replay(`${mess.owner}`);
          await GojoMdNx.groupLeave(m.chat)
            .then((res) => reply(jsonformat(res)))
            .catch((err) => reply(jsonformat(err)));
        }
        break;
      ...
      case "block":
        {
          ...
          let users = m.mentionedJid[0]
            ...
            ? m.quoted.sender
            : text.replace(/[^0-9]/g, "") + "@s.whatsapp.net";
          await GojoMdNx.updateBlockStatus(users, "block")
            .then((res) => reply(jsonformat(res)))
            .catch((err) => reply(jsonformat(err)));
        }
        break;
      case "unblock":
        {
          ...
          let users = m.mentionedJid[0]
            ...
            ? m.quoted.sender
            : text.replace(/[^0-9]/g, "") + "@s.whatsapp.net";
          await GojoMdNx.updateBlockStatus(users, "unblock")
            .then((res) => reply(jsonformat(res)))
            .catch((err) => reply(jsonformat(err)));
        }
        break;
      ...
      case "setsubject":
        {
          ...
          await GojoMdNx.groupUpdateSubject(m.chat, text)
      ...
      case "setdesk":
        {
          ...
          if (!isAdmins) replay(`${mess.admin}`);
          if (!text) replay(`Where Is The Text?`);
          await GojoMdNx.groupUpdateDescription(m.chat, text)
            .then((res) => reply(mess.success))
            .catch((err) => reply(jsonformat(err)));
        }
        break;
      case "setbotpp":
        {
          ...
          await GojoMdNx.updateProfilePicture(botNumber, { url: media }).catch(
      ...
      case "setgcpp":
        {
          ...
          if (/webp/.test(mime))
            return replay(`Send/Reply Image With Caption ${prefix + command}`);
          let media = await GojoMdNx.downloadAndSaveMediaMessage(quoted);
          await GojoMdNx.updateProfilePicture(m.chat, { url: media }).catch(
            (err) => fs.unlinkSync(media)
          );
          reply(mess.success);
        }
...
`;
      ...
      case "grup":
        {
          ...
          if (!isAdmins) return replay(`${mess.admin}`);
          if (args[0] === "close") {
            await GojoMdNx.groupSettingUpdate(m.chat, "announcement")
              .then((res) => reply(`Successful Closing The Group`))
              .catch((err) => reply(jsonformat(err)));
          } else if (args[0] === "open") {
            await GojoMdNx.groupSettingUpdate(m.chat, "not_announcement")
      ...
      case "editinfo":
        {
          ...
          if (!isAdmins) return replay(`${mess.admin}`);
          if (args[0] === "open") {
            await GojoMdNx.groupSettingUpdate(m.chat, "unlocked")
              .then((res) => reply(`Successfully Opened Edit Group Info`))
              .catch((err) => reply(jsonformat(err)));
          } else if (args[0] === "close") {
            await GojoMdNx.groupSettingUpdate(m.chat, "locked")
      ...
      case "ephemeral":
        {
          ...
          if (args[0] === "enable") {
            await GojoMdNx.sendMessage(m.chat, {
      ...
      case "sgif":
        {
          if (!quoted)
            return replay(`Reply Video/Image With Caption ${prefix + command}`);
          reply(mess.wait);
          if (/image/.test(mime)) {
            let media = await quoted.download();
            let encmedia = await GojoMdNx.sendImageAsSticker(m.chat, media, m, {
              packname: global.packname,
              author: global.author,
            });
            ...
            let media = await quoted.download();
            let encmedia = await GojoMdNx.sendVideoAsSticker(m.chat, media, m, {
              packname: global.packname,
              author: global.author,
            });
            await fs.unlinkSync(encmedia);
      ...
      case "stickmemex":
        {
          ...
          memek = await GojoMdNx.sendImageAsSticker(m.chat, meme, m, {
            packname: global.packname,
            author: global.author,
          });
      ...
      case "emojimix":
        {
          ...
          for (let res of anu.results) {
            let encmedia = await GojoMdNx.sendImageAsSticker(
              m.chat,
              res.url,
              m,
              {
      ...
      case "toimg":
        {
          ...
          if (!/webp/.test(mime))
            reply(`Reply Sticker With Caption *${prefix + command}*`);
          reply(mess.wait);
          let media = await GojoMdNx.downloadAndSaveMediaMessage(quoted);
      ...
      case "tovideo":
        {
          ...
          if (!/webp/.test(mime))
            return replay(`Reply Sticker With Caption *${prefix + command}*`);
          reply(mess.wait);
      ...
      case "tomp3":
        {
          ...
          GojoMdNx.sendMessage(
            m.chat,
            {
              document: audio,
              mimetype: "audio/mpeg",
              fileName: `Converted By ${GojoMdNx.user.name}.mp3`,
            },
            { quoted: m }
          );
        }
      ...
      case "ytsearch":
        {
          if (!text)
            return replay(`Example : ${prefix + command} Anime Story Whatsapp`);
      ...
      case "google":
        {
          if (!text)
            return reply(`Example : ${prefix + command} gojo shiba inu`);
...
🐦 Url : ${anu.url}`,
      ...
      case "karakterxxx":
        ...
        nexusnw
          ...
          .then(async (data) => {
            ...
            await GojoMdNx.send5ButLoc(from, txt, `© ${ownername}`, gam, but, {
              userJid: m.chat,
              quoted: m,
            });
          })
      ...
      case "gluetext":
        {
          if (!text)
            return reply(`Enter Text, Example : ${prefix + command} Xeon`);
          reply(mess.wait);
          GojoMdNx.sendMessage(
            m.chat,
            {
      ...
      case "stalk":
        {
          ...
          if (type.toLowerCase() == "ff") {
            if (!id)
              return reply(
                `No Query id, Example ${prefix + command} ff 552992060`
              );
            let anu = await fetchJson(
              api("zenz", "/api/nickff", {
            ...
            if (!id)
              return reply(
                `No Query id, Example : ${prefix + command} ml 214885010 2253`
              );
            if (!zone)
              return reply(
                `No Query id, Example : ${prefix + command} ml 214885010 2253`
            ...
            if (!id)
              return reply(
                `No Query id, Example ${prefix + command} aov 293306941441181`
              );
            let anu = await fetchJson(
            ...
            if (!id)
              return reply(
                `No Query id, Example ${prefix + command} pb riio46`
              );
            let anu = await fetchJson(
              api("zenz", "/api/nickpb", {
                apikey: global.APIKeys[global.APIs["zenz"]],
      ...
      case "tiktokaudiox":
        {
          ...
          let msg = await GojoMdNx.sendMessage(m.chat, buttonMessage, {
            quoted: m,
          });
          GojoMdNx.sendMessage(
            m.chat,
      ...
      case "jooxdl":
        {
          ...
          let msg = await GojoMdNx.sendImage(
            m.chat,
            anu.result.img,
...
${Object.entries(global.db.data.sticker)
  ...
  .join("\n")}
`.trim();
          GojoMdNx.sendText(m.chat, teks, m, {
    ...
    : ""
      ...
      case "handhold":
        ...
        axios.get(`https://api.waifu.pics/sfw/${command}`).then(({ data }) => {
          GojoMdNx.sendImageAsSticker(m.chat, data.url, m, {
            packname: global.packname,
            author: global.author,
          });
        });
...
└┬──────────────┈ ⳹
   ...
   └───────────────┈ ⳹`,
          ...
          GojoMdNx.relayMessage(m.chat, template.message, {
...
└┬──────────────┈ ⳹
   ...
   └───────────────┈ ⳹`,
      ...
      case "sewa":
        {
          GojoMdNx.sendMessage(
            ...
            {
              image: {
                url: "https://telegra.ph/file/c15f725add0381fb69c4b.jpg",
              },
      ...
      case "script":
        {
          reply(
            `GitHub : https://github.com/nexusNw/Whats-Bot-MD\n Dont Forget To Give Star\n\nYouTube : ${myweb}\nDont Forget To Watch Tutorial`
          );
        }
        break;
      case "allmenu":
